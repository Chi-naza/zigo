...
class MyBudgetListScreen extends StatelessWidget {
  ...
  MyBudgetListScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // checking if our list is empty, if empty show loading
      body: Obx(() {
          return budgetController.mySavedBudgetList.isEmpty? const ZigoLoading() : SingleChildScrollView(
            child: Column(
              children: [
      ...
      floatingActionButton: budgetController.mySavedBudgetList.isEmpty? null : FloatingActionButton.extended(
